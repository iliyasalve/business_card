        ...
        <div className="max-w-[1200px] w-full text-center relative z-10">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="mt-12 flex flex-row items-center justify-center gap-4 md:gap-6 w-full sm:w-auto">
              <Link
                href="/#home"
                className="flex-grow sm:flex-grow-0 px-8 md:px-10 py-4 bg-primary text-on-primary rounded-full font-bold flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-primary/20 transition-colors duration-100 active:scale-95 text-center"
              >
                {t('backToHome')}
              ...
              <Link
                href="/#projects"
                className="flex-grow sm:flex-grow-0 px-8 md:px-10 py-4 border border-outline/30 text-on-surface rounded-full font-bold hover:bg-surface-variant hover:text-primary transition-colors duration-100 text-center"
              >
                {t('viewProjects')}
              </Link>
            </div>
